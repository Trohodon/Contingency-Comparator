...
from core.xlsx_reader import list_sheet_names, read_sheet_table
...
def _build_conductor_from_condata_row(sheet_name: str, row: dict[str, list[str | None]]) -> Optional[Conductor]:
    ...
    return Conductor(
        ...
        steel_strand_dia_in=_to_float(_get_first_present(row, ["DIAM_INNERIN"])),
        steel_core_dia_in=None,
        od_in=od_in,
        ...
        dc_res_20c_ohm_per_mile=None,
        ac_res_25c_ohm_per_mile=r25,
        ac_res_50c_ohm_per_mile=None,
        ac_res_75c_ohm_per_mile=r75,
        ac_res_200c_ohm_per_mile=_to_float(_get_first_present(row, ["R200"])),
        stdol=stdol,
        gmr_ft=None,
        xa_60hz_ohm_per_mile=None,
        capacitive_reactance=None,
